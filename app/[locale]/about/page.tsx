...
import { ArrowRight, Languages, Sparkles, Heart, Zap, Eye, Users, Code, Lightbulb, Search, CheckCircle, ShoppingCart, Handshake } from "lucide-react";
    ...
    <div className="min-h-screen w-full flex flex-col items-center mochi-texture">
      ...
      <div className="fixed top-8 right-8 z-50">
        <MochiButton
          ...
          onClick={() => router.push(locale === "en" ? "/ja/about" : "/en/about")}
        >
