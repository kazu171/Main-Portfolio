...
import { ArrowRight, Languages, Sparkles, Heart, Zap, Eye, Users, Code, Lightbulb, MessageCircle, Search, CheckCircle, ShoppingCart, Handshake } from "lucide-react";
    ...
    <Layout className="mochi-texture" lang={lang}>
      ...
      <div className="fixed top-8 right-8 z-50">
        <MochiButton
          ...
          onClick={() => setLocation(lang === "en" ? "/ja/about" : "/en/about")}
        >
      ...
      <section className="py-16 text-center">
        <MochiButton size="lg" className="group" onClick={() => setLocation(`/${lang}/contact`)}>
          {lang === "en" ? "Get in Touch" : "お問い合わせ"} <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
        </MochiButton>
      </section>
    </Layout>
  );
